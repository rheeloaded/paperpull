...
| [`costco`](apps/costco) | Costco Wholesale | Receipts, in-warehouse, gas, pharmacy and costco.com orders | **Untested, built without an account. Have a membership? [Help test it](apps/costco/README.md#help-test-it-no-programming-needed)** ([#47](https://github.com/rheeloaded/paperpull/issues/47)) Orders page and sign-in verified on the public site, the rest is a guess waiting on one recording. Real Edge/Chrome, nothing clicked |
