"""What makes the USAA app different - everything else is paperpull_core.

This file used to be a full copy of the storage logic every other app carried.
That logic now lives in `paperpull_core`; what remains here is USAA's own
...
SPEC = AppSpec(
    ...
    csv_files=[
        CsvSpec("document_index_csv", "USAA Document Index.csv", DOCUMENT_INDEX_COLUMNS),
    ],
    config_defaults={
