"""Data models for the USAA receipt downloader.
...
class Purchase:
    ...
    order_number: str = ""  # USAA order / receipt / transaction identifier
    total: str = ""
    status: str = ""
    details_url: str = ""
    receipt_url: str = ""
    ...
    @property
    def key(self) -> str:
        """Unique internal key: Purchase Type + USAA identifier."""
