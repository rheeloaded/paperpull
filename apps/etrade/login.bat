...
echo   4. Then run:  paperpull etrade diagnose   (a survey for the maintainer)
echo.
...
echo setting.
echo.
.venv\Scripts\python.exe etrade_docs.py --open-browser %CFG%
echo.
pause
