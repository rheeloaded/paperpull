"""Filesystem, filename, CSV, and progress storage for the Robinhood receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\Robinhood Statements")
...
# One row per downloaded Robinhood document. Deliberately records NO
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "robinhood-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.document_index_csv = self.root / "Robinhood Document Index.csv"
        self.order_history_csv = self.root / "Robinhood Order History.csv"
        self.receipt_index_csv = self.root / "Robinhood Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD Robinhood <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}Robinhood {summary} {document_type}"
