"""Data models for the Amazon receipt downloader.
...
class Purchase:
    ...
    order_number: str = ""  # Amazon order / receipt / transaction identifier
    total: str = ""
    status: str = ""
    details_url: str = ""
    receipt_url: str = ""
    ...
    @property
    def key(self) -> str:
        """Unique internal key: Purchase Type + Amazon identifier."""
