"""Filesystem, filename, CSV, and progress storage for the Amazon receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\Amazon Receipts")
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "amazon-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.order_history_csv = self.root / "Amazon Order History.csv"
        self.receipt_index_csv = self.root / "Amazon Receipt Index.csv"
    ...
    def all_dirs(self) -> List[Path]:
        ...
        return [self.root, self.online, self.manual_review, self.logs,
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD Amazon <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}Amazon {summary} {document_type}"
