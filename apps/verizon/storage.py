"""Filesystem, filename, CSV, and progress storage for the Verizon receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\Verizon Statements")
...
# One row per downloaded Verizon document. Deliberately records NO
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "verizon-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.document_index_csv = self.root / "Verizon Document Index.csv"
        self.order_history_csv = self.root / "Verizon Order History.csv"
        self.receipt_index_csv = self.root / "Verizon Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD Verizon <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}Verizon {summary} {document_type}"
