"""Filesystem, filename, CSV, and progress storage for the Gap receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\Gap Receipts")
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.order_history_csv = self.root / "Gap Order History.csv"
        self.receipt_index_csv = self.root / "Gap Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD Gap <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}Gap {summary} {document_type}"
