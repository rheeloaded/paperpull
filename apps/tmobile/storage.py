"""Filesystem, filename, CSV, and progress storage for the T-Mobile receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\T-Mobile Statements")
...
# One row per downloaded T-Mobile document. Deliberately records NO
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "tmobile-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.document_index_csv = self.root / "T-Mobile Document Index.csv"
        self.order_history_csv = self.root / "T-Mobile Order History.csv"
        self.receipt_index_csv = self.root / "T-Mobile Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD T-Mobile <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}T-Mobile {summary} {document_type}"
