"""Data models for the Navy Federal receipt downloader.
...
class Purchase:
    ...
    order_number: str = ""  # Navy Federal order / receipt / transaction identifier
    total: str = ""
    status: str = ""
    details_url: str = ""
    receipt_url: str = ""
    ...
    @property
    def key(self) -> str:
        """Unique internal key: Purchase Type + Navy Federal identifier."""
