...
echo   4. Then run:  paperpull newrez diagnose   (a survey for the maintainer)
echo.
...
echo setting.
echo.
.venv\Scripts\python.exe newrez_docs.py --open-browser %CFG%
echo.
pause
