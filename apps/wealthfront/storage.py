"""Filesystem, filename, CSV, and progress storage for the Wealthfront receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\Wealthfront Receipts")
...
# One row per downloaded Wealthfront document. Deliberately records NO
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "wealthfront-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.document_index_csv = self.root / "Wealthfront Document Index.csv"
        self.order_history_csv = self.root / "Wealthfront Order History.csv"
        self.receipt_index_csv = self.root / "Wealthfront Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD Wealthfront <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}Wealthfront {summary} {document_type}"
