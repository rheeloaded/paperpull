"""Filesystem, filename, CSV, and progress storage for the American Express receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\American Express Statements")
...
# One row per downloaded American Express document. Deliberately records NO
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "amex-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.document_index_csv = self.root / "American Express Document Index.csv"
        self.order_history_csv = self.root / "American Express Order History.csv"
        self.receipt_index_csv = self.root / "American Express Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD [Owner ]American Express <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}American Express {summary} {document_type}"
