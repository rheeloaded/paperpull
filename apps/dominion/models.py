"""Data models for the Dominion receipt downloader.
...
class Purchase:
    ...
    order_number: str = ""  # Dominion order / receipt / transaction identifier
    total: str = ""
    status: str = ""
    details_url: str = ""
    receipt_url: str = ""
    ...
    @property
    def key(self) -> str:
        """Unique internal key: Purchase Type + Dominion identifier."""
