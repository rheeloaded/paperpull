"""Filesystem, filename, CSV, and progress storage for the Dominion receipt downloader.
...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\YOU\Downloads\Dominion Statements")
...
# One row per downloaded Dominion document. Deliberately records NO
...
def load_config(path: Optional[Path] = None) -> dict:
    ...
    cfg.setdefault("profile_dir", str(PROJECT_DIR / "dominion-browser-profile"))
...
class Paths:
    ...
    def __init__(self, output_dir: Path):
        ...
        self.document_index_csv = self.root / "Dominion Document Index.csv"
        self.order_history_csv = self.root / "Dominion Order History.csv"
        self.receipt_index_csv = self.root / "Dominion Receipt Index.csv"
...
def build_pdf_filename(purchase_date: str, summary: str,
    ...
    """YYYY-MM-DD Dominion <Summary> <Receipt|Invoice>[ (i of n)].pdf"""
    ...
    base = f"{date} {who}Dominion Energy {summary} {document_type}"
