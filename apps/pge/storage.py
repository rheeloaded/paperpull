"""What makes the PG&E app different - everything else is paperpull_core.

PG&E (Pacific Gas and Electric) billing statements downloader facts:
the folders it files into, how a document routes to one, its CSV
columns, and its config defaults.

To repair PG&E's page behavior, edit `pge_site.py` instead.
"""
...
SPEC = AppSpec(
    ...
    csv_files=[
        CsvSpec("document_index_csv", "PG&E Document Index.csv", DOCUMENT_INDEX_COLUMNS),
    ],
    config_defaults={
        "pilot_count": 5,
    },
